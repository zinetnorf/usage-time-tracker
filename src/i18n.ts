...
const resources = {
  es: {
    translation: {
      ...
      pdf: {
        export: "Exportar PDF",
        exportFull: "Exportar reporte completo (PDF)",
        reportTitle: "Usage Tracker — Reporte de uso",
        todaySection: "Hoy",
        trendSection: "Tendencia diaria",
        byAppSection: "Desglose por app",
  ...
  en: {
    translation: {
      ...
      pdf: {
        ...
        reportTitle: "Usage Tracker — Usage report",
        todaySection: "Today",
        trendSection: "Daily trend",
        byAppSection: "Breakdown by app",
